...
if(isset($_GET['c_id'])){
	$the_house_id = $_GET['c_id'];
            ...
            $post_query_count="SELECT * FROM houses where house_category = 'sale' ";
           ...
           if($page==""||$page==1){
            ...
            $count=ceil($count/$per_page);
                        ...
                        $query = "SELECT * FROM houses where house_category = 'sale' ORDER BY house_id Desc LIMIT $page_1,$per_page " ;
